...
public class example {
    public static void main(String[] args) {
        ...
        int mgcaffeinindrink=input.nextInt();
        int drinknumber = 10000/mgcaffeinindrink;
        System.out.println("It would take about "+drinknumber+" drinks for a lethal overdose");
/*
